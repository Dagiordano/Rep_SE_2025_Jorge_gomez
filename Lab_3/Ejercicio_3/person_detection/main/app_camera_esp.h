...
#define LED_DETECTION_PIN 2  // GPIO pin for person detection LED
...
#define LED_DETECTION_PIN 15  // GPIO pin for person detection LED
...
#define LED_DETECTION_PIN 18  // GPIO pin for person detection LED
...
#define LED_DETECTION_PIN 21  // GPIO pin for person detection LED
...
#define CAMERA_PIN_HREF 27
#define CAMERA_PIN_PCLK 25
#define LED_DETECTION_PIN GPIO_NUM_4  // GPIO pin for person detection LED (ESP32-CAM)
...
#define LED_DETECTION_PIN 2   // GPIO pin for person detection LED (default)
#endif
